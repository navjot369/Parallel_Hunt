...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    <div className="flex flex-col justify-center items-center h-full">
            ...
            {isLogin === ""? <Link href="/login" className="text-lg border-2 mx-4 border-[#ae5eff] text-[#ae5eff] py-1 px-3 rounded-md shadow-[3px_3px_0_0_#ae5eff] hover:shadow-none duration-500 my-3">Sign In</Link> : 
            <Link href="/profile" className="text-lg border-2 mx-4 border-[#ae5eff] text-[#ae5eff] py-1 px-3 rounded-md shadow-[3px_3px_0_0_#ae5eff] hover:shadow-none duration-500 my-3">Profile</Link>}
        </div>
    </div>
    </div>);
}